...
public class MemoryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fallosPant = (TextView) findViewById(R.id.textViewFallos);

        imagenes[0] = (ImageView) findViewById(R.id.imageView);
        imagenes[1] = (ImageView) findViewById(R.id.imageView2);
        imagenes[2] = (ImageView) findViewById(R.id.imageView3);
        imagenes[3] = (ImageView) findViewById(R.id.imageView4);
        imagenes[4] = (ImageView) findViewById(R.id.imageView5);
        imagenes[5] = (ImageView) findViewById(R.id.imageView6);
        imagenes[6] = (ImageView) findViewById(R.id.imageView7);
        imagenes[7] = (ImageView) findViewById(R.id.imageView8);
        imagenes[8] = (ImageView) findViewById(R.id.imageView9);
        imagenes[9] = (ImageView) findViewById(R.id.imageView10);
        imagenes[10] = (ImageView) findViewById(R.id.imageView11);
        imagenes[11] = (ImageView) findViewById(R.id.imageView12);
        imagenes[12] = (ImageView) findViewById(R.id.imageView13);
        imagenes[13] = (ImageView) findViewById(R.id.imageView14);
        imagenes[14] = (ImageView) findViewById(R.id.imageView15);
        imagenes[15] = (ImageView) findViewById(R.id.imageView16);
    ...
    public void generarTablero() {
        girarImagen = new GirarImagen(getApplicationContext());
        ...
        for (int k = 0; k < 16; ++k) {
            girarImagen.flipImage(getDrawable(R.drawable.estrella), cartas.get(k).first);
        }
    ...
    public Drawable setImagen (Integer num) {
        switch(num) {
            case 0:
                return getDrawable(R.drawable.charmander1);
            case 1:
                return getDrawable(R.drawable.charmander1);
            case 2:
                return getDrawable(R.drawable.bulbasaur2);
            case 3:
                return getDrawable(R.drawable.bulbasaur2);
            case 4:
                return getDrawable(R.drawable.pikachu3);
            case 5:
                return getDrawable(R.drawable.pikachu3);
            case 6:
                return getDrawable(R.drawable.psyduck4);
            case 7:
                return getDrawable(R.drawable.psyduck4);
            case 8:
                return getDrawable(R.drawable.snorlax5);
            case 9:
                return getDrawable(R.drawable.snorlax5);
            case 10:
                return getDrawable(R.drawable.squirtle6);
            case 11:
                return getDrawable(R.drawable.squirtle6);
            case 12:
                return getDrawable(R.drawable.evee7);
            case 13:
                return getDrawable(R.drawable.evee7);
            case 14:
                return getDrawable(R.drawable.gengar8);
            case 15:
                return getDrawable(R.drawable.gengar8);
            case -1:
                return getDrawable(R.drawable.estrella);
            default:
                return null;
        }
    }
    ...
    private class MyTask extends AsyncTask<Integer, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if ((carta1.second%2 == 0 && carta2.second == carta1.second+1) || (carta1.second%2 != 0 && carta1.second-1 == carta2.second)) {
                girarImagen.flipImage(getDrawable(R.drawable.tranparente), cartas.get(carta1.first).first);
                girarImagen.flipImage(getDrawable(R.drawable.tranparente), cartas.get(carta2.first).first);
                ...
                if (acabado == 16) {
                    ...
                    builder.setNegativeButton("Volver al menú", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(getApplicationContext(), "Volver al menú", Toast.LENGTH_LONG).show();
                            finishf();
                        }
                    });
                ...
                girarImagen.flipImage(getDrawable(R.drawable.estrella),cartas.get(carta1.first).first);
                girarImagen.flipImage(getDrawable(R.drawable.estrella),cartas.get(carta2.first).first);
                ++fallos;
                fallosPant.setText(""+fallos);
            }
            carta1 = Pair.create(-1,-1);
